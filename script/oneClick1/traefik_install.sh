...
wget https://github.com/bugybq/ResourceHosting/blob/master/script/oneClick1/traefik_conf.toml -N
wget https://github.com/bugybq/ResourceHosting/blob/master/script/oneClick1/traefik.yml -N
